...
@section('title','Modification du Anniversaire')
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Anniversaire') }}</div>
                    <div class="col-md-6">
                        <h4>Modification du Anniversaire </h4>
                    </div> 
                </div>
            </div>
        </div>
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::model($anniversaire, ['route' => ['anniversaire.update', $anniversaire->id], 'method' => 'put', 'class' => 'form-horizontal panel']) !!}
                        {{ csrf_field() }}
                    {{ csrf_field() }}
                    <style>
                         .mul-select{
                             ...
                             <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-5">
                                    <input type="text" name='libelle' class="form-control" value="{{ $anniversaire->libelle }}" placeholder="ex : Lancement du Produit X">
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-5">
                                    <input type="text" name='description' class="form-control" value="{{ $anniversaire->description }}" placeholder="ex : Cette anniversaire concerne le lancement du Produit X">
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-5">
                                    <input type="date" name='dateDebut' class="form-control" value="{{ $anniversaire->dateDebut }}" placeholder="">
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-5">
                                    <input type="date" name='dateFin' class="form-control" value="{{ $anniversaire->dateFin }}" placeholder="">
