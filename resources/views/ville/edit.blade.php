...
@section('title','Modification d\' une ville')
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::model($ville, ['route' => ['villes.update', $ville->id], 'method' => 'put', 'class' => 'form-horizontal panel']) !!}
                        {{ csrf_field() }}
                        <div class="form-group row d-flex align-items-center mb-5">
                            <label class="col-lg-4 form-control-label d-flex justify-content-lg-end"> Nom de la ville</label>
                            <div class="col-lg-5">
                                <input type="text" name='libelle' required="true" class="form-control" value="{{ $ville->libelle }}" >
